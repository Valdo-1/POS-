...
<div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
    <div>
        <h1 class="text-2xl font-black text-slate-800 tracking-tight">EDIT KATEGORI PRODUK</h1>
        <p class="text-slate-500 text-sm">Perbarui nama kategori menu resto KETARA</p>
    </div>
